...
export class MLIRContext implements vscode.Disposable {
  ...
  async prepareCompilationDatabaseServerOptions(
    ...
    let databases = config.get<string[]>(
      `${languageName}_compilation_databases`,
      workspaceFolder,
      [],
    );
   ...
   */
  async preparePDLLServerOptions(
    workspaceFolder: vscode.WorkspaceFolder,
    configsToWatch: string[],
    pathsToWatch: string[],
    additionalServerArgs: string[],
   ...
   *  accessible compilation databases.
   */
  async prepareTableGenServerOptions(
    workspaceFolder: vscode.WorkspaceFolder,
    configsToWatch: string[],
    pathsToWatch: string[],
    additionalServerArgs: string[],
  ...
  async activateWorkspaceFolder(
    ...
    if (languageName === "pdll") {
      await this.preparePDLLServerOptions(
        workspaceFolder,
        configsToWatch,
        filepathsToWatch,
        additionalServerArgs,
      ...
      await this.prepareTableGenServerOptions(
        workspaceFolder,
        configsToWatch,
        filepathsToWatch,
        additionalServerArgs,
